...
namespace MatFileHandler.Tests
{
    ...
    public class MatFileWriterTests
    {
        ...
        public void TestWrite()
        {
            ...
            var floattest = builder.NewArray<float>(1, 1);
            floattest[0] = 9.9334f;
            ...
            var actual = builder.NewFile(new[] { variable, floattestvariable });

            using (var fileStream = new System.IO.FileStream("output23.mat", System.IO.FileMode.Create))
            {
