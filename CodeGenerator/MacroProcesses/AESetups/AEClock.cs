...
{ 
        ...
        {
            public string NameOfClock { get; }
            public int FrequencyOfClock { get; }
            public string NameOfClockCallBack { get; }
            ...
            int clockidNum;
            public AEClock(string nameOfClock, int frequencyOfClock, string nameOfClockCallBack) : base("AEClock", $"clock{NumOfClocksMadeSoFar.ToString()}",AOTypeEnum.Clock)
            {
        ...
        protected override string _GenerateAEConfigSection(int numOfAOOfThisSameTypeGeneratesAlready)
            ...
            {
                return $"static void {NameOfClockCallBack}(TimerHandle_t xTimerHandle);" + "\n";
        }
            public override string GenerateMainInitializeSection()
            {

                string ret = $"static AEClock{GetTemplateType} {NameOfClock}L({FrequencyOfClock.ToString()}, {NameOfClockCallBack});" + "\n";
